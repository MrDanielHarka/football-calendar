...
export const renderEventPage = eventId => {
  ...
  <div class="card card--big">
    ...
    event.away !== null ? event.awayTeam.abbreviation : '???'
  }
        <br />
        match details
      </h1>
      ...
      <p>
        <span class="teamname">${
          event.homeTeam !== null ? event.homeTeam.name : 'Undecided'
        }</span>
        <br />
        vs
        <br />
      <span class="teamname">${
        event.awayTeam !== null ? event.awayTeam.name : 'Undecided'
      }</span>
      </p>
    ...
    <div class="flex-container">
      <div class="card info-wrapper">
        ...
        <div class="flex-container flex-container--small">
          ...
          <div>${
            event.homeTeam !== null ? event.homeTeam.officialName : 'Undecided'
          }</div>
        </div>
        <div class="flex-container flex-container--small">
          <div>Slug:</div>
          <div>${
            event.homeTeam !== null ? event.homeTeam.slug : 'Undecided'
          }</div>
        </div>
        <div class="flex-container flex-container--small">
          <div>Abbreviation:</div>
          <div>${
            event.homeTeam !== null ? event.homeTeam.abbreviation : 'Undecided'
          }</div>
        </div>
        <div class="flex-container flex-container--small">
      ...
      <div class="card info-wrapper">
        ...
        <div class="flex-container flex-container--small">
          <div>Official name:</div>
          <div>${
            event.awayTeam !== null ? event.awayTeam.officialName : 'Undecided'
          }</div>
        </div>
        <div class="flex-container flex-container--small">
          <div>Slug:</div>
          <div>${
            event.awayTeam !== null ? event.awayTeam.slug : 'Undecided'
          }</div>
        </div>
        <div class="flex-container flex-container--small">
          <div>Abbreviation:</div>
          <div>${
            event.awayTeam !== null ? event.awayTeam.abbreviation : 'Undecided'
          }</div>
        </div>
        <div class="flex-container flex-container--small">
          <div>Team country code:</div>
      ...
      <div>${event.result.message !== null ? event.result.message : ''}</div>
      </div>
    </div>
    ...
    event.dateVenue
        ...
        ${
          event.homeTeam !== null ? event.homeTeam.officialName : 'an undecided'
        } and ${
    event.awayTeam !== null ? event.awayTeam.officialName : 'an undecided team'
